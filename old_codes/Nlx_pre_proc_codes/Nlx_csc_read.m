...
if isempty(limits_ts)
    [ts_blocks, fs, samples_blocks, header] = Nlx2MatCSC(file_in, [1 0 1 0 1], 1, 1); %  [ts_blocks, fs, samples_blocks, header]
else
    [ts_blocks,  fs,samples_blocks, header] = Nlx2MatCSC(file_in, [1 0 1 0 1], 1, 4, limits_ts); %  [ts_blocks, fs, samples_blocks, header]
end
