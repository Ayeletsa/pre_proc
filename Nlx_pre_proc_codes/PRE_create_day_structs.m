function PRE_create_day_structs (p_in,rows)

excel_sheet=p_in.excel_sheet;
%% transform raw recordings into filterd LFP and detected spikes
PRE_loop_nlg2nlx (excel_sheet,'Experiments',rows)

%% Read excel table for desired recording days

P = NLG_PRE_read_and_fill_excel_sheet (p_in,excel_sheet,'Experiments',rows);
